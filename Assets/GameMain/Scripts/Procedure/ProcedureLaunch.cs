...
namespace TankBattle {
    ...
    public class ProcedureLaunch : ProcedureBase {
        ...
        private void InitSoundSettings() {
            ...
            GameEntry.Sound.Mute("SFX", GameEntry.Setting.GetBool(Constant.Setting.SoundMuted, false));
            GameEntry.Sound.SetVolume("SFX", GameEntry.Setting.GetFloat(Constant.Setting.SoundVolume, 1f));
            GameEntry.Sound.Mute("Driving", GameEntry.Setting.GetBool(Constant.Setting.SoundMuted, false));
            GameEntry.Sound.SetVolume("Driving", GameEntry.Setting.GetFloat(Constant.Setting.SoundVolume, 1f));
