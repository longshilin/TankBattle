...
namespace TankBattle {
    ...
    public static class SoundExtension {
        ...
        public static int? PlaySFX(this SoundComponent soundComponent, int soundId, Entity bindingEntity = null, object userData = null) {
            ...
            return soundComponent.PlaySound(AssetUtility.GetSoundAsset(drSound.AssetName), "SFX", Constant.AssetPriority.SoundAsset, playSoundParams, bindingEntity != null ? bindingEntity.Entity : null, userData);
        }

        public static int? PlayDriving(this SoundComponent soundComponent, int soundId, Entity bindingEntity = null, object userData = null) {
            IDataTable<DRSound> dtSound = GameEntry.DataTable.GetDataTable<DRSound>();
            DRSound drSound = dtSound.GetDataRow(soundId);
            if (drSound == null) {
                Log.Warning("Can not load sound '{0}' from data table.", soundId.ToString());
            ...
            return soundComponent.PlaySound(AssetUtility.GetSoundAsset(drSound.AssetName), "Driving", Constant.AssetPriority.SoundAsset, playSoundParams, bindingEntity != null ? bindingEntity.Entity : null, userData);
        }
